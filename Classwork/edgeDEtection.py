...
def interactive_edge_detection(image_path):
    ...
    while True:
        ...
        if choice == "1":
            ...
            combined_sobel= cv2.bitwise_or(sobelx.astype(np.uint8),sobely.astype(np.uint9))
            ...
            print("adjust kernel size for guassian blur (must be odd, default: 5")
            ...
            print("invlaid choice. please select between 1 and 6.")
interactive_edge_detection('C:\Shreyas\CodingalProjects\Ai\Classwork\pencil.jpg')
